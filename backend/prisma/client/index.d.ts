...
export namespace Prisma {
  ...
  */
  ...
  export type FeatureFlagOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "key" | "description" | "enabled" | "rolloutPercentage" | "createdAt" | "updatedAt", ExtArgs["result"]["featureFlag"]>
  ...
  interface FeatureFlagFieldRefs {
    ...
    readonly rolloutPercentage: FieldRef<"FeatureFlag", 'Int'>
  ...
  export type FeatureFlagWhereInput = {
    ...
    rolloutPercentage?: IntFilter<"FeatureFlag"> | number
  ...
  export type FeatureFlagScalarWhereWithAggregatesInput = {
    ...
    rolloutPercentage?: IntWithAggregatesFilter<"FeatureFlag"> | number
