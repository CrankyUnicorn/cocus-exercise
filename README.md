...
## Requirements
> Technical Exercise — Full-Stack TypeScript (React + Node)
> Objective
> 
...
> 
> GET /flags — list flags (with simple pagination: ?limit=&cursor= or ?page=)
> 
> GET /flags/:id — get details
> 
> PATCH /flags/:id — update the fields enabled, rolloutPercentage, and description
> 
> DELETE /flags/:id — remove a flag
> 
> GET /evaluate?key=*****&userId=***** — returns whether the flag is “active” for a user
> 
> Logic:
> 
